...
// Function to apply discounts on an order based on the Account status of the customer
...
int main()
{
    ...
    //addDrink function to order drinks on Kevin's order and catch InvalidInput
    try
    {
    ...
    ptr = &d2;
    //repeat of addDrink function but for Stuarts food order
    try
    {
...
//Function to apply discount by using getstatus function on temp account class
